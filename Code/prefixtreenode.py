...
class PrefixTreeNode:
    ...
    def is_terminal(self):
        """Return True if this prefix tree node terminates a string (end of word)."""
        # DONE: Determine if this node is terminal
        return True if self.terminal else False

    def num_children(self):
        """Return the number of children nodes this prefix tree node has."""
        # DONE: Determine how many children this node has
    ...
    def has_child(self, character):
        ...
        # DONE: Check if given character is amongst this node's children
    ...
    def get_child(self, character):
        ...
        if self.has_child(character):
            # DONE: Find child node for given character in this node's children
    ...
    def add_child(self, character, child_node):
        ...
        if not self.has_child(character):
            # DONE: Add given character and child node to this node's children
